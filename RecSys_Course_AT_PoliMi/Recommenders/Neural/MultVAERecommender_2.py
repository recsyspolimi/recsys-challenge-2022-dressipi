...
class MultVAERecommender(BaseRecommender, Incremental_Training_Early_Stopping, BaseTempFolder):
    RECOMMENDER_NAME = "MultVAERecommender_2"
    ...
    def fit(self,
        ...
        self.vae = MultVAE_original(self.p_dims, q_dims=self.q_dims, lr=self.learning_rate, lam=self.l2_reg,
                                    random_seed=98765)
    ...
    def load_model(self, folder_path, file_name=None):
        ...
        tf.compat.v1.reset_default_graph()
        self.vae = MultVAE_original(self.p_dims, lam=self.l2_reg)
        self.saver, self.logits_var, self.loss_var, self.train_op_var, self.merged_var = self.vae.build_graph()
...
class MultVAE_OptimizerMask(MultVAERecommender):
    ...
    def fit(self, epochs=100, batch_size=500, total_anneal_steps=200000, learning_rate=1e-3, l2_reg=0.01,
        ...
        super(MultVAE_OptimizerMask, self).fit(self, epochs=epochs, batch_size=batch_size, dropout=dropout,
