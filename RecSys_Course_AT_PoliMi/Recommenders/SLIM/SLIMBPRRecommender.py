...
class SLIMBPRRecommender(BaseItemSimilarityMatrixRecommender):
    """
    ...
    def __init__(self, URM_train, ):
        super(SLIMBPRRecommender, self).__init__(URM_train)
    ...
    def _run_epoch(self, n_epoch):
        ...
        for sample_num in range(self.n_users):
            ...
            if (sample_num + 1) % 150000 == 0 or (sample_num + 1) == self.n_users:
                ...
                print("Epoch {}, Iteration {} in {:.2f} seconds. Samples per second {:.2f}".format(n_epoch + 1,
                                                                                                   sample_num + 1,
                                                                                                   elapsed_time,
                                                                                                   samples_per_second))
