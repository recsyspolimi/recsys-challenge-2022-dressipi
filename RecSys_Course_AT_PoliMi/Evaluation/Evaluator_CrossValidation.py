...
class Evaluator(object):
    ...
    def __init__(self, URM_test_views, URM_test_purchases, cutoff_list,
        ...
        self.URM_test_views = URM_test_views

        if not isinstance(URM_test_purchases, list):
            self.URM_test = URM_test_purchases.copy()
            URM_test_purchases = [URM_test_purchases]
        else:
            raise ValueError("List of URM_test not supported")

        self.diversity_object = diversity_object

        self.n_users, self.n_items = URM_test_purchases[0].shape
        ...
        for URM_test in URM_test_purchases:
...
class EvaluatorHoldout_CrossValidation(Evaluator):
    """EvaluatorHoldout"""

    EVALUATOR_NAME = "EvaluatorHoldout"

    def __init__(self, URM_test_views, URM_test_purchases, cutoff_list, min_ratings_per_user=1, exclude_seen=True,
                 diversity_object=None,
                 ignore_items=None,
                 ignore_users=None,
                 verbose=True):

        super(EvaluatorHoldout_CrossValidation, self).__init__(URM_test_views, URM_test_purchases, cutoff_list,
...
class EvaluatorNegativeItemSample(Evaluator):
    ...
    def __init__(self, URM_test_purchases, URM_test_negative, cutoff_list, min_ratings_per_user=1, exclude_seen=True,
                 diversity_object=None,
                 ignore_items=None,
                 ignore_users=None):
        """
        ...
        :param ignore_users:
        """
        super(EvaluatorNegativeItemSample, self).__init__(URM_test_purchases, cutoff_list,
                                                          diversity_object=diversity_object,
