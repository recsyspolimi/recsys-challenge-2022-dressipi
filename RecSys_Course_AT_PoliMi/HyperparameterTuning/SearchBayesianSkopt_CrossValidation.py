...
class SearchBayesianSkopt_CrossValidation(SearchAbstractClass_CrossValidation):
    ...
    def __init__(self, recommender_class,
        ...
        assert evaluator_validation_list is not None, "{}: evaluator_validation_list must be provided".format(self.ALGORITHM_NAME)

        super(SearchBayesianSkopt_CrossValidation, self).__init__(recommender_class,
